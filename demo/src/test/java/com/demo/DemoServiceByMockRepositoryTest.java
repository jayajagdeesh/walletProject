...
@SpringBootTest
public class DemoServiceByMockRepositoryTest {
    ...
    public void testServiceWithOutActualRepository() throws EmployeeException{
        given(this.collectionEmployeeRepository.getEmployee(100))
    ...
    public void testGetEmployeeThrowsExceptionTest() throws EmployeeException{
        ...
        given(this.collectionEmployeeRepository.getEmployee(200))
                .willReturn(null);
